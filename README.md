...
- [LASER Beam Scattering in FOG: Mie \& Monte Carlo Simulation](#laser-beam-scattering-in-fog-mie--monte-carlo-simulation)
  ...
  - [📊 Key Results \& Visualizations](#-key-results--visualizations)
    - [Microphysical \& Bulk Optical Properties (Figures 1–4)](#microphysical--bulk-optical-properties-figures-14)
      ...
      - [Figure 2: Extinction Coefficient vs. Visibility](#figure-2-extinction-coefficient-vs-visibility)
      - [Figure 3: Single Scattering Albedo vs. Visibility](#figure-3-single-scattering-albedo-vs-visibility)
      - [Figure 4: Asymmetry Factor vs. Visibility](#figure-4-asymmetry-factor-vs-visibility)
    - [Photon Trajectory \& Spatial Diffusion Profiles (2D \& 3D)](#photon-trajectory--spatial-diffusion-profiles-2d--3d)
      ...
      - [2D Propagation Depth Comparison](#2d-propagation-depth-comparison)
    ...
    - [Animated 3D Photon Transport](#animated-3d-photon-transport)
      - [Rotating 3D Teardrop Diffusion](#rotating-3d-teardrop-diffusion)
      - [Rotating 2x2 Propagation Depth Matrix](#rotating-2x2-propagation-depth-matrix)
      - [Step-by-step Photon Propagation](#step-by-step-photon-propagation)
    - [Angular Scattering Intensity Sweeps](#angular-scattering-intensity-sweeps)
      - [Figure 5: Albedo Sweep](#figure-5-albedo-sweep)
      - [Figure 6: Asymmetry Sweep](#figure-6-asymmetry-sweep)
      - [Figure 7: Backscattering Intensity Across Wavelengths \& Fog Types ($V=0.6$ km)](#figure-7-backscattering-intensity-across-wavelengths--fog-types-v06-km)
...
#### 2D Propagation Depth Comparison 
...
#### Rotating 3D Teardrop Diffusion 
...
#### Step-by-step Photon Propagation 
...
#### Figure 7: Backscattering Intensity Across Wavelengths & Fog Types ($V=0.6$ km)
